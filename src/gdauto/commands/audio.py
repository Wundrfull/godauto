...
from gdauto.formats.tres import ExtResource as TresExtResource
...
def add_player(
    ...
    Examples:
      ...
      gdauto audio add-player --scene scenes/main.tscn --name BGM --stream res://audio/music.ogg --bus Music --autoplay

      gdauto audio add-player --scene scenes/player.tscn --name JumpSound --stream res://audio/jump.ogg --type AudioStreamPlayer2D --bus SFX
    """
    try:
...
def create_bus_layout(
    ...
    Examples:
      ...
      gdauto audio create-bus-layout --bus "SFX:Master" --bus "Music:Master" audio/bus_layout.tres

      gdauto audio create-bus-layout --bus "SFX:Master" --bus "Music:Master" --bus "UI:Master" audio/bus_layout.tres
    """
    try:
