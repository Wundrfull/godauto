...
def create(
    ...
    Examples:
      ...
      gdauto shader create --template flash shaders/flash.tres

      gdauto shader create --template outline shaders/outline.tres

      gdauto shader create --file shaders/custom.gdshader shaders/custom_shader.tres
    """
    try:
        if template_name:
...
def create_material(
    ...
    Examples:
      ...
      gdauto shader create-material --shader res://shaders/flash.tres materials/flash_material.tres
    """
    try:
