...
def generate_skill_md() -> str:
    """Generate a SKILL.md document from the auto-godot CLI command tree.
    ...
    ctx = click.Context(cli, info_name="auto-godot")
...
def _render_skill(info: dict) -> str:
    ...
    for cmd_name in sorted(commands):
        ...
        if _should_skip(cmd_info):
            continue
        _render_command(cmd_name, cmd_info, "auto-godot", lines)
...
_EXAMPLE_OVERRIDES: dict[str, str] = {
    "auto-godot project info": "auto-godot project info ./my-game",
    "auto-godot project validate": "auto-godot project validate ./my-game",
    "auto-godot project create": "auto-godot project create my-new-game",
    "auto-godot sprite import-aseprite": "auto-godot sprite import-aseprite character.json",
    "auto-godot sprite split": "auto-godot sprite split sheet.png --frame-size 32x32",
    "auto-godot sprite create-atlas": (
        "auto-godot sprite create-atlas a.png b.png -o atlas.png"
    ),
    "auto-godot sprite validate": "auto-godot sprite validate character.tres",
    "auto-godot resource inspect": "auto-godot resource inspect player.tres",
    "auto-godot scene list": "auto-godot scene list .",
    "auto-godot scene create": "auto-godot scene create definition.json",
    "auto-godot export release": 'auto-godot export release --preset "Windows Desktop"',
    "auto-godot export debug": 'auto-godot export debug --preset "Windows Desktop"',
    "auto-godot export pack": "auto-godot export pack --preset Export",
    "auto-godot skill generate": "auto-godot skill generate -o SKILL.md",
}
