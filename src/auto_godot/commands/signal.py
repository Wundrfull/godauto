...
def connect_signal(
    ...
    Examples:
      ...
      auto-godot signal connect --scene scenes/main.tscn --signal pressed --from Button --to . --method _on_button_pressed

      auto-godot signal connect --scene scenes/game.tscn --signal timeout --from Timer --to . --method _on_timer_timeout

      auto-godot signal connect --scene scenes/player.tscn --signal body_entered --from Area2D --to . --method _on_area_body_entered --flags 4
    """
    try:
